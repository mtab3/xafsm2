#############################################################################
# Makefile for building: XafsM-058
# Generated by qmake (2.01a) (Qt 4.7.4) on: ? 3? 9 14:19:55 2012
# Project:  XafsM-058.pro
# Template: app
# Command: /usr/local/bin/qmake-qt4 -o Makefile XafsM-058.pro
#############################################################################
...
Makefile: XafsM-058.pro  /usr/local/share/qt4/mkspecs/freebsd-g++/qmake.conf /usr/local/share/qt4/mkspecs/common/g++.conf \
		/usr/local/share/qt4/mkspecs/common/unix.conf \
		/usr/local/share/qt4/mkspecs/qconfig.pri \
		/usr/local/share/qt4/mkspecs/modules/qt_phonon.pri \
		/usr/local/share/qt4/mkspecs/modules/qt_webkit_version.pri \
	...
	$(QMAKE) -o Makefile XafsM-058.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/XafsM-0581.0.0 || $(MKDIR) .tmp/XafsM-0581.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/XafsM-0581.0.0/ && $(COPY_FILE) --parents Atoms.h MainWindow.h PeriodicT.h SelMC.h Stars.h StarsSV.h XafsM.h XView.h .tmp/XafsM-0581.0.0/ && $(COPY_FILE) --parents XafsM.qrc .tmp/XafsM-0581.0.0/ && $(COPY_FILE) --parents Atoms.cpp Fio.cpp MainWindow.cpp Measurement.cpp MwCommon.cpp MwLog.cpp MwMeas.cpp MwSetup.cpp MwView.cpp PeriodicT.cpp SelMC.cpp Stars.cpp StarsSV.cpp Timer.cpp XafsM.cpp XView.cpp .tmp/XafsM-0581.0.0/ && $(COPY_FILE) --parents MainWindow.ui PeriodicT.ui SelMC.ui StarsSV.ui .tmp/XafsM-0581.0.0/ && $(COPY_FILE) --parents XafsMsg_jp.ts .tmp/XafsM-0581.0.0/ && (cd `dirname .tmp/XafsM-0581.0.0` && $(TAR) XafsM-0581.0.0.tar XafsM-0581.0.0 && $(COMPRESS) XafsM-0581.0.0.tar) && $(MOVE) `dirname .tmp/XafsM-0581.0.0`/XafsM-0581.0.0.tar.gz . && $(DEL_FILE) -r .tmp/XafsM-0581.0.0
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_PeriodicT.cpp moc_SelMC.cpp moc_Stars.cpp moc_StarsSV.cpp moc_XView.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_PeriodicT.cpp moc_SelMC.cpp moc_Stars.cpp moc_StarsSV.cpp moc_XView.cpp
