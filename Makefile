...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ? 1? 20 13:41:33 2013
# Project:  XafsM2.pro
# Template: app
...
INCPATH       = -I../../../local/share/qt4/mkspecs/freebsd-g++ -I. -I../../../local/include/qt4/QtCore -I../../../local/include/qt4/QtNetwork -I../../../local/include/qt4/QtGui -I../../../local/include/qt4 -I. -I. -I. -I../../../local/include/qt4 -I../../../local/include
LINK          = g++
...
DIST          = ../../../local/share/qt4/mkspecs/common/unix.conf \
		...
		../../../local/share/qt4/mkspecs/common/g++-base.conf \
		../../../local/share/qt4/mkspecs/common/g++-unix.conf \
...
$(TARGET): ui_FrameWGrid.h ui_MainWindow.h ui_MCAView.h ui_PeriodicT.h ui_SelMC.h ui_StarsSV.h ui_XView.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: XafsM2.pro  ../../../local/share/qt4/mkspecs/freebsd-g++/qmake.conf ../../../local/share/qt4/mkspecs/common/unix.conf \
		../../../local/share/qt4/mkspecs/common/gcc-base.conf \
		../../../local/share/qt4/mkspecs/common/gcc-base-unix.conf \
		../../../local/share/qt4/mkspecs/common/g++-base.conf \
		../../../local/share/qt4/mkspecs/common/g++-unix.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents Atoms.h AUnit.h ChCoord.h MainWindow.h MCAView.h Mccd.h MouseC.h MsgType.h MultiUnits.h PeriodicT.h SelMC.h SMsg.h Stars.h StarsSV.h Status.h TYView.h ViewCtrl.h XafsM.h XView.h XYView.h .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents XafsM.qrc .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents Atoms.cpp AUnit.cpp ChCoord.cpp Dark.cpp Fio.cpp Goto.cpp MainWindow.cpp MCAView.cpp Measurement.cpp Monitor.cpp MouseC.cpp MsgType.cpp MultiUnits.cpp MwCommon.cpp MwLog.cpp MwMeas.cpp MwSetup.cpp MwSSDSetUp.cpp MwView.cpp PeriodicT.cpp ReadDef.cpp Scan.cpp SelMC.cpp SMsg.cpp Stars.cpp StarsSV.cpp Status.cpp TYView.cpp ViewCtrl.cpp XafsM.cpp XView.cpp XYView.cpp .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents FrameWGrid.ui MainWindow.ui MCAView.ui PeriodicT.ui SelMC.ui StarsSV.ui XView.ui .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents XafsMsg_jp.ts .tmp/XafsM21.0.0/ && (cd `dirname .tmp/XafsM21.0.0` && $(TAR) XafsM21.0.0.tar XafsM21.0.0 && $(COMPRESS) XafsM21.0.0.tar) && $(MOVE) `dirname .tmp/XafsM21.0.0`/XafsM21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/XafsM21.0.0
...
compiler_moc_header_make_all: moc_AUnit.cpp moc_ChCoord.cpp moc_MainWindow.cpp moc_MCAView.cpp moc_MouseC.cpp moc_MultiUnits.cpp moc_PeriodicT.cpp moc_SelMC.cpp moc_Stars.cpp moc_StarsSV.cpp moc_Status.cpp moc_TYView.cpp moc_ViewCtrl.cpp moc_XView.cpp moc_XYView.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_AUnit.cpp moc_ChCoord.cpp moc_MainWindow.cpp moc_MCAView.cpp moc_MouseC.cpp moc_MultiUnits.cpp moc_PeriodicT.cpp moc_SelMC.cpp moc_Stars.cpp moc_StarsSV.cpp moc_Status.cpp moc_TYView.cpp moc_ViewCtrl.cpp moc_XView.cpp moc_XYView.cpp
...
moc_Status.cpp: ui_FrameWGrid.h \
		AUnit.h \
		XafsM.h \
		Stars.h \
		SMsg.h \
...
compiler_uic_make_all: ui_FrameWGrid.h ui_MainWindow.h ui_MCAView.h ui_PeriodicT.h ui_SelMC.h ui_StarsSV.h ui_XView.h
compiler_uic_clean:
	-$(DEL_FILE) ui_FrameWGrid.h ui_MainWindow.h ui_MCAView.h ui_PeriodicT.h ui_SelMC.h ui_StarsSV.h ui_XView.h
ui_FrameWGrid.h: FrameWGrid.ui
	/usr/local/bin/uic-qt4 FrameWGrid.ui -o ui_FrameWGrid.h
