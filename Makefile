...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ? 10? 3 21:00:18 2012
# Project:  XafsM2.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents Atoms.h AUnit.h MainWindow.h MsgType.h PeriodicT.h SelMC.h Stars.h StarsSV.h XafsM.h XView.h .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents XafsM.qrc .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents Atoms.cpp AUnit.cpp Fio.cpp MainWindow.cpp Measurement.cpp MsgType.cpp MwCommon.cpp MwLog.cpp MwMeas.cpp MwSetup.cpp MwView.cpp PeriodicT.cpp ReadDef.cpp SelMC.cpp Stars.cpp StarsSV.cpp Timer.cpp XafsM.cpp XView.cpp .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents MainWindow.ui PeriodicT.ui SelMC.ui StarsSV.ui .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents XafsMsg_jp.ts .tmp/XafsM21.0.0/ && (cd `dirname .tmp/XafsM21.0.0` && $(TAR) XafsM21.0.0.tar XafsM21.0.0 && $(COMPRESS) XafsM21.0.0.tar) && $(MOVE) `dirname .tmp/XafsM21.0.0`/XafsM21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/XafsM21.0.0
