...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ? 12? 19 09:35:57 2012
# Project:  XafsM2.pro
# Template: app
...
$(TARGET): ui_MainWindow.h ui_MCAView.h ui_PeriodicT.h ui_SelMC.h ui_StarsSV.h ui_XView.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents Atoms.h AUnit.h ChCoord.h MainWindow.h MCAView.h Mccd.h MsgType.h MultiUnits.h PeriodicT.h SelMC.h SMsg.h Stars.h StarsSV.h XafsM.h XView.h .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents XafsM.qrc .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents Atoms.cpp AUnit.cpp ChCoord.cpp Fio.cpp Goto.cpp MainWindow.cpp MCA.cpp MCAView.cpp Measurement.cpp Monitor.cpp MsgType.cpp MultiUnits.cpp MwCommon.cpp MwLog.cpp MwMeas.cpp MwSetup.cpp MwView.cpp PeriodicT.cpp ReadDef.cpp Scan.cpp SelMC.cpp SMsg.cpp Stars.cpp StarsSV.cpp XafsM.cpp XView.cpp .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents MainWindow.ui MCAView.ui PeriodicT.ui SelMC.ui StarsSV.ui XView.ui .tmp/XafsM21.0.0/ && $(COPY_FILE) --parents XafsMsg_jp.ts .tmp/XafsM21.0.0/ && (cd `dirname .tmp/XafsM21.0.0` && $(TAR) XafsM21.0.0.tar XafsM21.0.0 && $(COMPRESS) XafsM21.0.0.tar) && $(MOVE) `dirname .tmp/XafsM21.0.0`/XafsM21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/XafsM21.0.0
...
compiler_moc_header_make_all: moc_AUnit.cpp moc_ChCoord.cpp moc_MainWindow.cpp moc_MCAView.cpp moc_MultiUnits.cpp moc_PeriodicT.cpp moc_SelMC.cpp moc_Stars.cpp moc_StarsSV.cpp moc_XView.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_AUnit.cpp moc_ChCoord.cpp moc_MainWindow.cpp moc_MCAView.cpp moc_MultiUnits.cpp moc_PeriodicT.cpp moc_SelMC.cpp moc_Stars.cpp moc_StarsSV.cpp moc_XView.cpp
...
compiler_uic_make_all: ui_MainWindow.h ui_MCAView.h ui_PeriodicT.h ui_SelMC.h ui_StarsSV.h ui_XView.h
compiler_uic_clean:
	-$(DEL_FILE) ui_MainWindow.h ui_MCAView.h ui_PeriodicT.h ui_SelMC.h ui_StarsSV.h ui_XView.h
...
MCA.o: MCA.cpp SMsg.h \
		...
		ui_MCAView.h \
		ChCoord.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MCA.o MCA.cpp
